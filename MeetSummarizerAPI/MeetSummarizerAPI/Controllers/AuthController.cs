...
namespace MeetSummarizerAPI.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        //        return Ok(new { Token = token, User = userRole });
        //    }
        //    else if (userRole.Role.RoleName == "HeaderTeam")
        //    {
        //        var token = _authService.GenerateJwtToken(model.UserName, new[] { "HeaderTeam" });
        //        return Ok(new { Token = token, User = userRole });
        //    }
        ...
        public async Task<IActionResult> Login([FromBody] LoginModel model)
        {
            ...
            if (userRole != null)
            {
                ...
                return Ok(new
                {
                    ...
                    {
                        userRole.UserName,
                        userRole.TeamId,  // הוספת ה- teamId
                        userRole.Role
                    }
                });
            }
